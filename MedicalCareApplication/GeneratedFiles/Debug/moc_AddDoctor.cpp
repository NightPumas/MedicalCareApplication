...
QT_MOC_LITERAL(1, 10, 7), // "AddFunc"
QT_MOC_LITERAL(2, 18, 0) // ""

    },
    "AddDoctor\0AddFunc\0"
};
...
void AddDoctor::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        AddDoctor *_t = static_cast<AddDoctor *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
const QMetaObject AddDoctor::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_AddDoctor.data,
      qt_meta_data_AddDoctor,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *AddDoctor::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_AddDoctor.stringdata0))
        return static_cast<void*>(const_cast< AddDoctor*>(this));
