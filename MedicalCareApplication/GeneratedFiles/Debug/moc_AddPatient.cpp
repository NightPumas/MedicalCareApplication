/****************************************************************************
** Meta object code from reading C++ file 'AddPatient.hpp'
**
...
#error "The header file 'AddPatient.hpp' doesn't include <QObject>."
...
QT_MOC_LITERAL(1, 11, 20), // "AddPatientToDatabase"
QT_MOC_LITERAL(2, 32, 0) // ""

    },
    "AddPatient\0AddPatientToDatabase\0"
};
...
void AddPatient::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->AddPatientToDatabase(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
const QMetaObject AddPatient::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_AddPatient.data,
